...
public class SpacingFragment extends Fragment {
    ...
    public static SpacingFragment newInstance() {
        SpacingFragment fragment = new SpacingFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_edit_text_spacing, container, false);
