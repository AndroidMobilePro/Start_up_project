...
public class EditingToolssAdapter extends RecyclerView.Adapter<EditingToolssAdapter.ViewHolder> {
    ...
    public EditingToolssAdapter(OnItemSelected onItemSelected) {
        mOnItemSelected = onItemSelected;
        mToolList.add(new ToolModel("Background", R.drawable.ic_camera, ToolType.BACKGROUND));
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_editing_toolss, parent, false);
